package com.akkulov.javarush1.java_core.packet9.ex2_crud;
...
/**
 * https://javarush.com/quests/lectures/questcore.level07.lecture10; CRUD 2
 */
        ...
        case "-c":
          synchronized (allPeople) {
            for (int i = 1; i < args.length; i = i + 3) {
              ...
              Person person =
                  sex.equals("м") ? Person.createMale(name, date) : Person.createFemale(name, date);
